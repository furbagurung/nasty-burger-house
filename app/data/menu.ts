...
const drinkImages: Partial<Record<string, string>> = {
  Sprite: "/images/final-menu-photo/sprite-v2.jpeg",
  Coke: "/images/final-menu-photo/coke-v2.jpeg",
  "Coke No Sugar": "/images/menu/coke no sugar.webp",
  Fanta: "/images/final-menu-photo/fanta-v2.jpeg",
  Water: "/images/final-menu-photo/water-v2.jpg",
};
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    category: "burgers",
    price: 19,
    image: "/images/final-menu-photo/Peri-Beast-v2.jpg",
    canUpgrade: true,
    dietaryTags: ["Halal"],
  ...
  },
  {
    ...
    category: "burgers",
    price: 21,
    image: "/images/final-menu-photo/hooked-v2.jpg",
    canUpgrade: true,
    dietaryTags: ["Halal"],
  ...
  },
  {
    ...
    category: "burgers",
    price: 19,
    image: "/images/final-menu-photo/bbq-beast-smoked.jpg",
    featured: true,
    canUpgrade: true,
    dietaryTags: ["Halal"],
    modifierIds: burgerModifierIds,
  ...
  },
  {
    ...
    price: 15,
    image: "/images/final-menu-photo/dirty-eggplants-v2.jpg",
    canUpgrade: true,
    dietaryTags: ["Vegetarian"],
    modifierIds: sauceAddOns,
  ...
  },
  {
    ...
    category: "loaded-sides",
    price: 15,
    image: "/images/final-menu-photo/buffalo-fury-v2.jpg",
    canUpgrade: true,
    dietaryTags: ["Halal"],
    modifierIds: sauceAddOns,
  ...
  },
  {
    ...
    category: "kids",
    price: 14,
    image: "/images/final-menu-photo/monster-cheese-nasty-kids-menu.jpg",
    canUpgrade: true,
    isKidsItem: true,
    dietaryTags: ["Halal"],
  ...
  },
  {
    ...
    category: "beast-boxes",
    price: 59.99,
    image: "/images/final-menu-photo/duo-beast-box-mew-smoked-bbq-beast.jpg",
  ...
  },
  {
    ...
    category: "beast-boxes",
    price: 79.99,
    image: "/images/final-menu-photo/family-beast-box-v2.jpeg",
