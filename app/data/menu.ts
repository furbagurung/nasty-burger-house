...
const drinkImages: Partial<Record<string, string>> = {
  Sprite: "/images/final-menu-photo/sprite.jpeg",
  Coke: "/images/final-menu-photo/coke.jpeg",
  "Coke No Sugar": "/images/menu/coke no sugar.webp",
  Fanta: "/images/final-menu-photo/fanta.jpeg",
  Water: "/images/final-menu-photo/water.jpg",
};
...
export const menuItems: MenuItem[] = [
  {
    ...
    category: "burgers",
    price: 19,
    image: "/images/final-menu-photo/the-og-nasty.jpg",
    featured: true,
    canUpgrade: true,
    dietaryTags: ["Halal"],
  ...
  },
  {
    ...
    category: "burgers",
    price: 19,
    image: "/images/final-menu-photo/Peri-Beast.jpg",
    canUpgrade: true,
    dietaryTags: ["Halal"],
  ...
  },
  {
    ...
    category: "burgers",
    price: 21,
    image: "/images/final-menu-photo/hooked.jpg",
    canUpgrade: true,
    dietaryTags: ["Halal"],
  ...
  },
  {
    ...
    category: "burgers",
    price: 17,
    image: "/images/final-menu-photo/green-beast.jpg",
    canUpgrade: true,
  ...
  },
  {
    ...
    category: "burgers",
    price: 19,
    image: "/images/final-menu-photo/bbq-beast.jpg",
    featured: true,
    canUpgrade: true,
    dietaryTags: ["Halal"],
    modifierIds: burgerModifierIds,
  ...
  },
  {
    ...
    price: 15,
    image: "/images/final-menu-photo/dirty-eggplants.jpg",
    canUpgrade: true,
    dietaryTags: ["Vegetarian"],
    modifierIds: sauceAddOns,
  ...
  },
  {
    ...
    category: "loaded-sides",
    price: 15,
    image: "/images/final-menu-photo/buffalo-fury.jpg",
    canUpgrade: true,
    dietaryTags: ["Halal"],
    modifierIds: sauceAddOns,
  ...
  },
  {
    ...
    category: "loaded-sides",
    price: 10,
    image: "/images/final-menu-photo/nasty-fries.jpg",
    canUpgrade: true,
    dietaryTags: ["Vegetarian"],
    modifierIds: sauceAddOns,
  ...
  },
  {
    ...
    category: "kids",
    price: 14,
    image: "/images/final-menu-photo/dino-nuggets.jpg",
    canUpgrade: true,
    isKidsItem: true,
    dietaryTags: ["Halal"],
    modifierIds: sauceAddOns,
  ...
  },
  {
    ...
    price: 34.99,
    image: "/images/final-menu-photo/solo-beast-box.jpeg",
    featured: true,
  ...
  },
  {
    ...
    category: "beast-boxes",
    price: 59.99,
    image: "/images/final-menu-photo/duo-beast-box.jpeg",
  ...
  },
  {
    ...
    category: "beast-boxes",
    price: 79.99,
    image: "/images/final-menu-photo/family-beast-box.jpeg",
  ...
  },
  {
    ...
    category: "sweet",
    price: 12,
    image: "/images/final-menu-photo/mango-pudding.jpeg",
    dietaryTags: ["Vegetarian"],
  },
